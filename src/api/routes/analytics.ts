...
const PermitRecordSchema = z.object({
  ...
  hazards: z.union([z.array(z.unknown()), z.string()]).nullish(),
  controlMeasures: z.union([z.array(z.unknown()), z.string()]).nullish(),
  workShift: z.string().nullish(),
  activeDays: z.union([z.array(z.string()), z.string()]).nullish(),

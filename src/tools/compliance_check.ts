...
LOCATION: ${args.jobContext.location ?? "Not specified"}
ENVIRONMENT: ${args.jobContext.environment ?? "Not specified"}
EQUIPMENT: ${(args.jobContext.equipment ?? []).join(", ") || "Not specified"}
